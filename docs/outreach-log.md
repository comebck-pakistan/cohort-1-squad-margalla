# Outreach Log — Potential Sellers Contacted

Tracking outreach to Pakistani online sellers for customer discovery. This log is updated as new sellers are contacted and as responses come in.

## Status Legend
- **Messaged** — outreach sent, awaiting response
- **Responded** — seller replied, conversation in progress
- **Interviewed** — full conversation completed (see `interviews-with-potential-users.md`)
...
|---|---|---|---|---|---|---|---|
| theperfectfitco5 | Messaged | 605 | WhatsApp | sajidislam | 03009455419 | Clothing | — |
| rohan_fabricss | Messaged | 66.6k | WhatsApp | sajidislam | 03152755556 | Clothing | — |
| bnuwardrobeofficial | Messaged | 104k | WhatsApp | sajidislam | +923101560270 | Clothing | — |
| sajidahyaseen | Messaged | 60.2k | Instagram DM | sajidislam | +923278862544 | Clothing | Multan |
| Amina Nazim | Messaged | 174k | Instagram DM | sajidislam | — | Accessories | — |
| manihahomebakers | Messaged | 1973 | Instagram DM | sajidislam | +923214321490 | Other | Lahore |

---

## Summary

- **Total contacted today:** 6
- **Channels used:** WhatsApp (3), Instagram DM (3)
- **Categories reached:** Clothing (4), Accessories (1), Other/Bakery (1)
- **Next step:** Follow up in 24–48 hours if no response; move responders to `interviews-with-potential-users.md` once a full conversation is completed.
